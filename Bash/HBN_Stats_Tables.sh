...
tree -dai -L 1 /mnt/methlab-drive/methlab_data/HBN/MRI/Site-CBIC_Derivatives_UZH/ | head -n -2 | tail -n +3 > /mnt/methlab-drive/methlab-analysis/anpapa/CBICIDs.txt
...
tree -dai -L 1 /mnt/methlab-drive/methlab_data/HBN/MRI/Site-RU_Derivatives_UZH/ | head -n -2 | tail -n +3 > /mnt/methlab-drive/methlab-analysis/anpapa/RUIDs.txt
...
tree -dai -L 1 /mnt/methlab-drive/methlab_data/HBN/MRI/Site-SI_Derivatives_UZH/ | head -n -2 | tail -n +3 > /mnt/methlab-drive/methlab-analysis/anpapa/SIIDs.txt
...
tree -dai -L 1 /mnt/methlab-drive/methlab_data/HBN/MRI/Site-CUNY_Derivatives_UZH/ | head -n -2 | tail -n +3 > /mnt/methlab-drive/methlab-analysis/anpapa/CUNYIDs.txt
