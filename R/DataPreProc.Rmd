...
```{r}
allDataCSV <- choose.files(default = params$AllDataCSV, multi = F, caption =  "AllData.csv")
...
qualityData <- qualityData[unique(qualityData$EID),]
mri2 <- mri %>% left_join(qualityData, by = "EID", keep =F)
```
