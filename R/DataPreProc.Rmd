...
##MRI
#MRIDir <- "T:/HBN/MRI/"
MRIDir <- "E:/Box Sync/Arbeit/UZH/MasterArbeit/ScienceCloud/"
#mriDirPrefix = "Site-"
mriDirPrefix = ""
...
finishedStates <- read.csv("../Python/fsFinishedTable.csv",col.names = c("Path", "Sub", "State"))
filesComplete <- read.csv("../Python/filesFound.csv",col.names = c("Path", "Sub", "State"))
...
# mri %>% filter(Protocol == "HCP")
mri <- mri[order(mri$Protocol),]
