...
# data_old[,features] <- lapply(data_old[,features], as.numeric)
# data_old$Age <- as.numeric(data_old$Age)
# 
# rhm_old <- data_old[which(data_old$Sex == params$Sex & data_old$EHQ_Total >= params$EHQCutoff),]
# rhm_old$site <- factor(rhm_old$site)
# setdiff(rhm$EID, rhm_old$EID)
# setdiff(rhm_old$EID, rhm$EID)
