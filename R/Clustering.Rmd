...
generateFSGDASD(asdZScored, variables, params$GLMProjectNameClusteredASD, directory = params$GLMFolder)
generateGLMASD(features= params$Features,title = params$GLMProjectNameClusteredASD, directory = params$GLMFolder)

hcNoMissings <- hcZScored
hcNoMissings$clust <- 3
allSubs <- rbind(asdZScored, hcNoMissings[hcNoMissings$Subject == 0,])
generateFSGDALL(allSubs, variables, params$GLMProjectNameClusteredASDvHC, directory = params$GLMFolder)
generateGLMALL(features= params$Features,title = params$GLMProjectNameClusteredASDvHC, directory = params$GLMFolder)

hcNoClusters <- allSubs
hcNoClusters$clust <- hcNoClusters$Subject +1
generateFSGDASD(hcNoClusters, variables, params$GLMProjectNameASDvHC, directory = params$GLMFolder)
generateGLMASD(features= params$Features,title = params$GLMProjectNameASDvHC, directory = params$GLMFolder)
