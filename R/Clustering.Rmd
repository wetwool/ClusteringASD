...
fsGLMdata <- asdZScored[asdZScored$site == "SI",][,c("lh.aparc.thickness", "ASSQ_Total","SRS_Total", "clust")]
fsGLMdata$clust = 2
...
f <- generateFSGD(title, list(class1,class2), variables, fsGLMdata, paste("ASDanatomy_all_",fsgdSite,".fsgd",sep = ""))
