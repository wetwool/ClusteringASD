...
variables <- c("SNR")#"ASSQ_Total", "SRS_Total")

hcNoMissings <- hcZScored
hcNoMissings$clust <- 3
allSubs <- rbind(asdZScored, hcNoMissings[hcNoMissings$Subject == 0,])
generateFSGDALL(allSubs, variables, params$GLMProjects$ClusteredASDvtHCControlled$Title, directory = params$GLMFolder)
...
#                title = params$GLMProjects$ClusteredASDvtHCControlled$Title, 
#                contrasts = params$GLMProjects$ClusteredASDvtHCControlled$Contrasts, 
