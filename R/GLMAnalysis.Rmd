...
displayMGH <- function(fileCollection,feature, type, analysisName = "_"){
 ...
 colFn_diverging  = grDevices::colorRampPalette(RColorBrewer::brewer.pal(11, name="RdBu"));
  ...
  # rgla = list('snapshot_png'=paste(analysisName,feature, "png", sep = "."))
  # rgla = list('trans_fun'=limit_fun(0.0000001,100));
  cm <- vis.data.on.fsaverage(subj_dir, surface = "pial", morph_data_lh = lh_clust, morph_data_rh = rh_clust,bg="aparc", style ="default",  views=c('t4'),draw_colorbar =T, makecmap_options = list('colFn'=colFn_diverging, 'symm'=TRUE))#,rglactions=rgla)
  # cm
  ...
  # combine.colorbar.with.brainview.image(output_brain_img, output_cbar_img, paste(analysisName,feature, "png", sep = "."))
}
